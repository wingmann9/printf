...
/**
 * struct flag_s - Define a flags struct.
 * @flag: Character representing a flag.
 * @value: Integer value of the flag.
 *
 * Desc: A new type defining a flags struct.
 */
